...
import { User, Subject, AttendanceRecord, ClassSession, Task, ProductivitySession } from '../types';
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <AppContext.Provider value={{
      user, subjects, attendance, schedule, tasks, productivity,
      login, register, logout, addSubject, addAttendance, addSchedule, deleteSchedule,
      addTask, updateTask, deleteTask, addProductivity, resetData
    }}>
      {children}
    </AppContext.Provider>
  );
